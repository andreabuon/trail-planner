...
<body>
	...
	<form action='php/login_script.php' method='post' class='container' name='login_form'>
		<div class='form-group row form-floating'>
			<input name='username' id='username' type='text' maxlength='25' size='25' required autofocus class='form-control' placeholder='Username' pattern='[a-zA-Z0-9]+'>
			<label for='username'>Username</label>
		</div>
		<div class='form-group row form-floating'>
			<input name='password' id='password' type='password' maxlength='25' size='25' required class='form-control' placeholder='Password'>
